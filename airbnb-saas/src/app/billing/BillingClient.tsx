    ...
    <main className="mx-auto max-w-4xl space-y-6 p-6">
      <header>
        ...
        <p className="mt-1 text-sm text-gray-400">
          Buy a credits pack or start a subscription. Manage payment details anytime in the Stripe customer portal.
        </p>
      </header>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <PricingCard
          ...
          disabled={disabled}
          badge="One-time"
          bullets={["Pay once, use anytime", "No renewal", "Good for occasional users"]}
        />
        <PricingCard
          title="Subscription"
